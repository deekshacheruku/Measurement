...
public class LengthTest {
    ...
    void testIs1CentimeterEquals1Centimeter() throws InValidQuantityValueException {
        Length firstQuantity = new Length(1, QuantityType.LengthType.CENTIMETER);
        Length secondQuantity = new Length(1, QuantityType.LengthType.CENTIMETER);
    ...
    void testIs1CentimeterNotEquals2Centimeter() throws InValidQuantityValueException {
        Length firstQuantity = new Length(1, QuantityType.LengthType.CENTIMETER);
        Length secondQuantity = new Length(2, QuantityType.LengthType.CENTIMETER);
    ...
    void testThrowsExceptionWhenQuantityValueIsZero() {
        assertThrows(InValidQuantityValueException.class, () -> new Length(0, QuantityType.LengthType.CENTIMETER));
    }

    @Test
    void testThrowsExceptionWhenQuantityValueIsNegative() {
        assertThrows(InValidQuantityValueException.class, () -> new Length(-1, QuantityType.LengthType.CENTIMETER));
    }

    @Test
    void testIf1MeterEquals100Centimeter() throws InValidQuantityValueException {
        Length meter1 = new Length(1, QuantityType.LengthType.METER);
        Length centimeter100 = new Length(100, QuantityType.LengthType.CENTIMETER);
    ...
    void testIf2MetersNotEquals100Centimeter() throws InValidQuantityValueException {
        Length meters2 = new Length(2, QuantityType.LengthType.METER);
        Length centimeter100 = new Length(100, QuantityType.LengthType.CENTIMETER);
    ...
    void test100CentimeterEquals0_001Kilometer() throws InValidQuantityValueException {
        Length centimeters100 = new Length(100, QuantityType.LengthType.CENTIMETER);
        Length kilometers0_001 = new Length(0.001, QuantityType.LengthType.KILOMETER);
    ...
    void test1000CentimeterNotEquals0_001Kilometer() throws InValidQuantityValueException {
        Length kilometer0_001 = new Length(0.001, QuantityType.LengthType.KILOMETER);
        Length centimeter1000 = new Length(1000, QuantityType.LengthType.CENTIMETER);
    ...
    void testIfAdditionOf1MeterAnd100CentimeterEquals2Meter() throws InValidQuantityValueException {
        Length meter1 = new Length(1, QuantityType.LengthType.METER);
        Length centimeter100 = new Length(100, QuantityType.LengthType.CENTIMETER);
        Length expectedSum = new Length(2, QuantityType.LengthType.METER);
    ...
    void testIfAdditionOf200CentimeterAnd1KilometerEquals1002Meter() throws InValidQuantityValueException {
        Length centimeter200 = new Length(200, QuantityType.LengthType.CENTIMETER);
        Length kilometer1 = new Length(1, QuantityType.LengthType.KILOMETER);
        Length expectedSum = new Length(1002, QuantityType.LengthType.METER);
    ...
    void testIfAdditionOf1MeterAnd100CentimeterNotEquals1Meter() throws InValidQuantityValueException {
        Length meter1 = new Length(1, QuantityType.LengthType.METER);
        Length centimeter100 = new Length(100, QuantityType.LengthType.CENTIMETER);
        Length expectedSum = new Length(1, QuantityType.LengthType.METER);
    ...
    void testIfSubtractionOf1MeterAnd50CentimeterEquals0_5Meter() throws InValidQuantityValueException, NegativeSubtractionException {
        Length meter1 = new Length(1, QuantityType.LengthType.METER);
        Length centimeter0_5 = new Length(50, QuantityType.LengthType.CENTIMETER);
        Length expectedDifference = new Length(0.5, QuantityType.LengthType.METER);
    ...
    void testIfSubtractionOf2000CentimeterAnd1MeterEquals19Meter() throws InValidQuantityValueException, NegativeSubtractionException {
        Length centimeter2000 = new Length(2000, QuantityType.LengthType.CENTIMETER);
        Length meter1 = new Length(1, QuantityType.LengthType.METER);
        Length expectedDifference = new Length(19, QuantityType.LengthType.METER);
    ...
    void testIfSubtractionOf3MeterAnd100CentimeterNotEquals1Meter() throws InValidQuantityValueException, NegativeSubtractionException {
        Length meter3 = new Length(3, QuantityType.LengthType.METER);
        Length centimeter100 = new Length(100, QuantityType.LengthType.CENTIMETER);
        Length expectedDifference = new Length(1, QuantityType.LengthType.METER);
    ...
    void testThrowsExceptionIfGreaterQuantitySubtractedFromSmallerQuantity() throws InValidQuantityValueException {
        Length largerQuantity = new Length(2, QuantityType.LengthType.KILOMETER);
        Length smallerQuantity = new Length(1, QuantityType.LengthType.METER);
